package com.baidu.idl.face.example.login.util;
...
public final class DaemonEnv {
     ...
     */
    public static void initialize(@NonNull Context app, @NonNull Class<TraceServiceImpl> serviceClass, @Nullable Integer wakeUpInterval) {
        sApp = app;
